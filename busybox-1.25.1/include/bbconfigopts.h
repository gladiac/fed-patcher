...
"CONFIG_SYSROOT=\"/tmp/ndk-toolchain-arm/sysroot\"\n"
"CONFIG_EXTRA_CFLAGS=\"-DANDROID -D__ANDROID__ -DSK_RELEASE -nostdlib -fpic -fno-short-enums -fgcse-after-reload -frename-registers\"\n"
